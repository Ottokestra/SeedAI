    ...
    <div style={{ width: "100%", height: 360 }}>
      <ResponsiveContainer>
        <LineChart data={rows} margin={{ top: 8, right: 20, left: 0, bottom: 0 }}>
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="good" name="좋은 조건 성장" stroke="#22c55e" strokeWidth={2} dot={false} />
          <Line type="monotone" dataKey="bad"  name="나쁜 조건 성장" stroke="#ef4444" strokeWidth={2} dot={false} strokeDasharray="6 3" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );

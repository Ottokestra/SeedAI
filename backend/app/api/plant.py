...
from app.models.schemas import PlantAnalysisResponse, PlantIdentification, PlantGrowthInsightResponse, MonthlyDataAnalysis, MonthlyDataRow
...
from app.services.db_utils import save_growth_log, load_growth_history, save_identification_data
...
async def get_monthly_data_analysis(
    ...
    try:
        ...
        return MonthlyDataAnalysis(
            ...
            growth_graph=result["growth_graph"],  # 차트 데이터 포함
            monthly_data=monthly_data_rows,
